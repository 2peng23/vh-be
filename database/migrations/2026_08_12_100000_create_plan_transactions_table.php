    ...
    public function up(): void
    {
        ...
        DB::table('subscription_plan_offerings')->insert([
            ...
            [
                ...
                'price' => 1499,
                'vehicle_limit' => 10,
                'details' => 'Complete vehicle management for small vehicle operations.',
                'is_active' => true,
                'created_at' => $now,
                'updated_at' => $now,
            ],
            ...
            [
                ...
                'price' => 2999,
                'vehicle_limit' => 30,
                'details' => 'Complete vehicle management for growing vehicle operations.',
                'is_active' => true,
                'created_at' => $now,
                'updated_at' => $now,
            ],
            ...
            [
                ...
                'price' => 5999,
                'vehicle_limit' => 100,
                'details' => 'Complete vehicle management for large vehicle operations.',
                'is_active' => true,
                'created_at' => $now,
                'updated_at' => $now,
            ],
