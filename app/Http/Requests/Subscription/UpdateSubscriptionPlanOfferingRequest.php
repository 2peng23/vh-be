...
class UpdateSubscriptionPlanOfferingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'plan' => ['required', Rule::in(['trial', 'starter', 'business', 'enterprise']), Rule::unique('subscription_plan_offerings')->where(fn ($query) => $query->where('duration_months', $this->integer('duration_months')))->ignore($offering instanceof SubscriptionPlanOffering ? $offering->id : null)],
